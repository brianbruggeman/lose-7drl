#!/usr/bin/env python
# -*- coding: utf-8 -*-
# This is code modified to use python3.6 and libtcod-cffi from
# RogueBasin's excellent python tutorial.
#
# See: http://www.roguebasin.com/index.php?title=Complete_Roguelike_Tutorial,_using_python%2Blibtcod
#
import os
import sys
import math
...
def main_menu():
    img = tcod.image_load('menu-background.png')
    ...
    while not tcod.console_is_window_closed():
        ...
        tcod.console_print_ex(0, SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 4, tcod.BKGND_NONE, tcod.CENTER, 'TOMBS OF THE ANCIENT KINGS')
        tcod.console_print_ex(0, SCREEN_WIDTH // 2, SCREEN_HEIGHT - 2, tcod.BKGND_NONE, tcod.CENTER, 'By Jotaf')
...
font_path = os.path.normpath(os.path.join(os.path.dirname(__file__), '..', 'lose', 'data', 'assets', 'game-font.png'))
tcod.console_set_custom_font(font_path, tcod.FONT_TYPE_GREYSCALE | tcod.FONT_LAYOUT_ASCII_INROW)
